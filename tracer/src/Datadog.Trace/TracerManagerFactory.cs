...
namespace Datadog.Trace
{
    internal class TracerManagerFactory
    {
        ...
        private IApi GetApi(ImmutableTracerSettings settings, IDogStatsd statsd, Action<Dictionary<string, float>> updateSampleRates, IApiRequestFactory apiRequestFactory)
        {
            ...
            return new Api(apiRequestFactory, statsd, updateSampleRates, settings.ExporterInternal.PartialFlushEnabledInternal);
        }
